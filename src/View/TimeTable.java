...
public class TimeTable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Xây dựng các hệ thống nhúng", "Đảm bảo chất lượng phần mềm", "Kiến trúc và thiết kế phần mềm", "Phát triển các ứng dụng thiết bị di động", "Phát triển phần mềm hướng dịch vụ", "Chuyên đề" };
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MMH", "Tên MH", "Nhóm MH", "Tổ TH", "STC", "Mã lớp", "Sĩ số", "TH", "Thứ", "Tiết bắt đầu", "ST", "Phòng", "Tuần"
            }
        ) {
